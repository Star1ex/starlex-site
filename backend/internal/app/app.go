...
func StartServer() {
	...
	httpHandlers := handlers.NewHandlers(userService, workspaceService, taskService, folderService, verificationService, passwordService, sprintService, discussionService, db, authConfig)
