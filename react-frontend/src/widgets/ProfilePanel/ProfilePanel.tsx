...
import { Token } from '@/shared/lib/auth'; // ✅ Полный путь как у вас

const getToken = () => Token.get(); // ✅ Как в вашем RightSidebar
...
const TaskBoard: React.FC<TaskBoardProps> = () => {
  ...
  // ✅ Как в вашем RightSidebar - простая fetch функция
